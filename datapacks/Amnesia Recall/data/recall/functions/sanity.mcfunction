...
execute at @a[scores={sanity=0..}] run item replace entity @p armor.head with player_head[custom_name='{"bold":true,"text":"Jonny Bohm Schliemann\'s"}',enchantments={levels:{"minecraft:binding_curse":1},show_in_tooltip:false},hide_additional_tooltip={}] 1
