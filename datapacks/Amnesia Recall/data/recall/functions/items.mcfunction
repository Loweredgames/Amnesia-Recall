...
execute at @a[scores={laudano=1}] run kill @e[type=item,nbt={Item:{id:"minecraft:potion",count:1}}]
execute at @a[scores={laudano=1..}] run scoreboard objectives remove laudano


execute at @a[scores={drop_oil=1}] run kill @e[type=item,nbt={Item:{id:"minecraft:ink_sac",count:1}}]
